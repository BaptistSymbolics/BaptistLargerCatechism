...
% Custom command for verse references that wraps to 2 columns if too long
\newcounter{tempcount}
...
% Using a different approach to prevent page breaks within questions
\let\oldsection\section
\renewcommand{\section}[1]{%
  \needspace{5\baselineskip}%
  \pagebreak[3]% Suggest a page break here if convenient
  \nopagebreak\oldsection{#1}%
  \nopagebreak% Forbid page breaks after the heading
}
